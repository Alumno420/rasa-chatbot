...
## Beta v3.0: **Gold Mask**
## Quinta release beta del rasa-chatbot de mi trabajo de STEMBach. Esta versión es del formal.
### Novedades:
...
**Full Changelog**: [https://github.com/Alumno420/rasa-chatbot/compare/v2.0-beta-ecru-prior...v2.1-beta-universal-container](https://github.com/Alumno420/rasa-chatbot/compare/v2.3-beta-weary-chart...v3.0-beta-gold-mask)
